var t = Object.defineProperty,
  ...
  m = (r, i, s) =>
    i in r
      ? t(r, i, { enumerable: !0, configurable: !0, writable: !0, value: s })
      : (r[i] = s),
  p = (t, r) => {
    for (var i in r || (r = {})) o.call(r, i) && m(t, i, r[i]);
    if (s) for (var i of s(r)) e.call(r, i) && m(t, i, r[i]);
    return t;
  },
  a = (t, s) => r(t, i(s));
import { I as n } from '../../entry/js/index-DO2-PIoQ.js';
...
import './@lexical-B5_fZosS.js';
import './@monaco-editor-C3MYHJUS.js';
...
import './common-hooks-xISUJ5g6.js';
import './component-util-vaeYxGsA.js';
import './confirm-delete-dialog-BaRkfMsN.js';
...
import './delimiter-form-field-Bs-9pmeo.js';
...
import './dropdown-menu-CPsKvLwF.js';
import './dunder-proto-DQtCUrgC.js';
import './dynamic-form-CrYmz0uU.js';
...
import './index-BCOACp_r.js';
import './index-BRbIhg1L.js';
import './index-BX_UjHJi.js';
import './index-CsRjWUXO.js';
import './index-DTbYNSxO.js';
import {
  f as b,
  c as f,
  e as g,
...
import './json-schema-traverse-BHxOLD4P.js';
import './jszip-DTOwhxH_.js';
import './katex-mb6KXHQQ.js';
import './knowledge-Dd5ClXAK.js';
import './knowledge-service-C7bGPLFK.js';
import { L as c } from './label-CZQfd38B.js';
import './large-model-form-field-C0Of2M_S.js';
import './lexical-C7KX_f9Z.js';
import './llm-form-field-Bpuny-1T.js';
...
import './memory-service-CooRx5gz.js';
...
import './multi-select-CGXAOfS_.js';
import './navigate-hooks-DCA2uWDS.js';
import './next-DDv3R9T9.js';
import './next-POMbaFh-.js';
...
import './radio-DJQIZKxJ.js';
import './radio-group-CNv2Z8Ke.js';
import './ragflow-avatar-CcbNLvr2.js';
import './ragflow-form-Cdwsmcxy.js';
import './ragflow-pagination-D2Ba4l0Q.js';
...
import { r as j, j as l } from './react-Clxusn8M.js';
...
import './react-router-BrN_DTYY.js';
...
import './skeleton-card-COuvf9AR.js';
import './sonner-TueGljap.js';
import './space-separated-tokens-DO9R2H4G.js';
import './spin-Bdnf2V7y.js';
import './spotlight-BB0OF-yF.js';
import './state-local-DHPJ_3N6.js';
...
import { S as d } from './switch-CY9Wp7P2.js';
import './table-BZEAlElj.js';
import './table-skeleton-CRTSqFk3.js';
import './tabs-BkKyNeIu.js';
...
import './use-agent-request-CZJ4cPbP.js';
import './use-build-options-CcZ6r_Ad.js';
import './use-callback-ref-Dsx2f-yX.js';
import './use-chat-logic-BQRVp0st.js';
import './use-document-request-Dj6rxTR0.js';
import './use-fetch-data-oYVyEVHm.js';
import './use-get-begin-query-C5gK4wZ4.js';
import './use-handle-filter-submit-Ch1X8WIr.js';
import './use-knowledge-graph-item-gzGUCIDo.js';
import './use-knowledge-request-B9r3Nu0Q.js';
import './use-llm-request-CEg4uBkM.js';
import './use-mcp-request-CC7bUsuH.js';
import './use-send-agent-message-CmD-60zr.js';
...
import './use-user-setting-request-DRiTjvUt.js';
...
const k = ({ schema: t, validationNode: r, onChange: i, depth: s = 0 }) => {
  const o = u(),
    [e, m] = j.useState(h(t, (t) => t.minItems, void 0)),
    [k, y] = j.useState(h(t, (t) => t.maxItems, void 0)),
    [w, N] = j.useState(h(t, (t) => t.uniqueItems || !1, !1)),
    I = j.useId(),
    q = j.useId(),
    z = j.useId(),
    O = g(t) || { type: 'string' },
    C = h(O, (t) => t.type || 'string', 'string'),
    P = () => {
      const r = a(p({ type: 'array' }, x(t) ? {} : t), {
        minItems: e,
        maxItems: k,
        uniqueItems: w || void 0,
      });
      void 0 === r.items && O && (r.items = O);
      const s = {};
      for (const [t, i] of Object.entries(r)) void 0 !== i && (s[t] = i);
      i(s);
    },
    L = (r) => {
      const s = a(p({ type: 'array' }, x(t) ? {} : t), { items: r });
      i(s);
    },
    M = j.useMemo(() => {
      var t, i;
      return null ==
        (i =
          null == (t = null == r ? void 0 : r.validation.errors)
            ? void 0
            : t.find((t) => 'minmax' === t.path[0]))
        ? void 0
        : i.message;
    }, [r]),
    F = j.useMemo(() => {
        ...
        children: [
          l.jsxs('div', {
            ...
            children: [
              l.jsx(c, {
                htmlFor: I,
                className: (!!M || !!F) && 'text-destructive',
                children: o.arrayMinimumLabel,
              }),
              l.jsx(n, {
                id: I,
                type: 'number',
                ...
                value: null != e ? e : '',
                onChange: (t) => {
                  const r = t.target.value ? Number(t.target.value) : void 0;
                  m(r);
                },
                onBlur: P,
                placeholder: o.arrayMinimumPlaceholder,
                className: f('h-8', !!M && 'border-destructive'),
              }),
            ],
          }),
          l.jsxs('div', {
            ...
            children: [
              l.jsx(c, {
                htmlFor: q,
                className: (!!M || !!S) && 'text-destructive',
                children: o.arrayMaximumLabel,
              }),
              l.jsx(n, {
                id: q,
                type: 'number',
                ...
                onBlur: P,
                placeholder: o.arrayMaximumPlaceholder,
                className: f('h-8', !!M && 'border-destructive'),
              }),
            ],
          }),
          (!!M || !!F || !!S) &&
            l.jsx('div', {
              className:
                'text-xs text-destructive italic md:col-span-2 whitespace-pre-line',
              children: [M, null != F ? F : S].filter(Boolean).join('\n'),
            }),
        ],
      }),
      l.jsxs('div', {
        ...
        children: [
          ...
          l.jsx(c, {
            ...
            children: o.arrayForceUniqueItemsLabel,
          }),
        ],
      }),
      l.jsxs('div', {
        ...
        children: [
          l.jsxs('div', {
            ...
            children: [
              l.jsx(c, { children: o.arrayItemTypeLabel }),
              l.jsx(v, {
                value: C,
                onChange: (t) => {
                  L(
          ...
          l.jsx(b, { schema: O, validationNode: r, onChange: L, depth: s + 1 }),
        ],
      }),
    ],
  });
...
export { k as default };
//# sourceMappingURL=array-editor-Bpdeg3Xn.js.map
